...
public class RVSettingData : MonoBehaviour
{
    ...
    public GUIStyle Get_name_collection_item(GUIStyle g)
    {
        GUIStyle foldoutStyle = new GUIStyle(g);
        foldoutStyle.normal.textColor = name_collection_item;
        foldoutStyle.focused.textColor = name_collection_item;
        foldoutStyle.active.textColor = name_collection_item;
        foldoutStyle.hover.textColor = name_collection_item;
        foldoutStyle.onNormal.textColor = name_collection_item;
        foldoutStyle.onActive.textColor = name_collection_item;
        foldoutStyle.onFocused.textColor = name_collection_item;
        foldoutStyle.onHover.textColor = name_collection_item;
        foldoutStyle.fontStyle = FontStyle;
        return foldoutStyle;
    }
    ...
    {
        bgColor_selected = new Color(106f / 255f, 255f / 255f, 86f / 255f, 55f/255f);
        ...
        name_collection_item = new Color(1f / 255f, 103f / 255f, 19f / 255f, 1f);
        name_property = new Color(146f / 255f, 73f / 255f, 0f / 255f, 1f);
        name_class = new Color(0f / 255f, 94f / 255f, 103f / 255f, 1f);
        name_class_onSelect = new Color(25f / 255f, 133f / 255f, 143f / 255f, 1f);
